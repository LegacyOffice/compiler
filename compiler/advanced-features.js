...
function displayOptimizations(optimizations) {
    ...
    let html = '<p style="margin:5px 0;color:#666;font-size:14px;">Code optimizations improve performance and efficiency. This analyzer suggests improvements like removing unused variables or simplifying expressions.</p>';
    
    if (optimizations.length === 0) {
        html += '<div class="success">✅ No optimizations suggested</div>';
    } else {
